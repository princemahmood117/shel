...
//           <ConnectExplore></ConnectExplore>
//           <RelatedProjects currentProjectId={project.id} projectType={project.type} allProjects={projects}></RelatedProjects>
//         </div>
//     </>
//   );
// };
...
import LoadingScreen from "../../Components/LoadingScreen/LoadingScreen";
import ProgressImage from "./LandmarkProject/ProgressImage";
import Amenities from "./Amenities"; // Import the new Amenities component
import ProjectGallary from "./ProjectGallary";
import ProjectDetailsMap from "./ProjectDetailsMap";
import ConnectExplore from "./ConnectExplore";
import RelatedProjects from "./RelatedProjects";
...
const ProjectDetails = () => {
  ...
  return (
    <>
      ...
      {/* At A Glance Section */}
      <div className="min-h-screen lg:mt-40 md:mt-16 mt-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div className="w-full">
              <div className="bg-gradient-to-b from-blue-400 to-blue-200 overflow-hidden h-screen shadow-xl">
